    ...
    <div className="w-56 bg-white min-h-screen border-r border-gray-200">
      <div className="py-6 px-4">
        ...
        <nav className="flex flex-col space-y-3">
          <NavLink onClick={closeSidebar} to="/" className={navLinkClass}>Recruiter ID</NavLink>
          <NavLink onClick={closeSidebar} to="/client" className={navLinkClass}>Client</NavLink>
          <NavLink onClick={closeSidebar} to="/candidate-data" className={navLinkClass}>Candidate Data</NavLink>
        </nav>
      </div>
    </div>
    </div>
